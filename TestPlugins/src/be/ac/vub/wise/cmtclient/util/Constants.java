...
public class Constants {
    ...
    public static String URLCMT = "";//http://localhost:8080/CMTServerRestFull/cmt";
    public static String WSCMT = ""; //ws://localhost:8080/CMTServerRestFull/pubsub";
    ...
    public static void setURLCMT(String url){
        Constants.URLCMT = url;
    }
    
    public static void setWSCMT(String url){
        Constants.WSCMT = url;
    }
}
